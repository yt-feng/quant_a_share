...
- 大盘情绪：情绪温度、成交额、涨跌比、涨跌停、真实涨停池/炸板池、连板高度、封板资金、北向资金、ETF 资金、人气榜、指数涨跌、趋势图；日期区间与行情状态会联动复盘统计，并显示 14 类数据源实时体检和表格新鲜度。
...
- 自选：本地分组、自选表、删除与分组管理。
- LLM 分析：主题热度、主题全字段、新闻证据、主题个股、选股池、板块看板、个股评估矩阵、产业链分析；主题类型、交易日、关键词、来源、策略、排序、列集、页大小和翻页都会联动表格并进入问答上下文。
